...
module "brainstore" {
  ...
  enable_cpu_autoscaling                               = var.brainstore_enable_cpu_autoscaling
  cpu_autoscaling_target_percent                       = var.brainstore_cpu_autoscaling_target_percent
  cpu_autoscaling_estimated_warmup_seconds             = var.brainstore_cpu_autoscaling_estimated_warmup_seconds
  ...
  fast_reader_enable_cpu_autoscaling                   = var.brainstore_fast_reader_enable_cpu_autoscaling
  fast_reader_cpu_autoscaling_target_percent           = var.brainstore_fast_reader_cpu_autoscaling_target_percent
  fast_reader_cpu_autoscaling_estimated_warmup_seconds = var.brainstore_fast_reader_cpu_autoscaling_estimated_warmup_seconds
