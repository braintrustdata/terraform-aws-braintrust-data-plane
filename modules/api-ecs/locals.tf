locals {
  ...
  base_env_vars = merge({
    ...
    BRAINSTORE_ENABLED                                = var.brainstore_hostname != null ? "true" : "false"
    BRAINSTORE_DEFAULT                                = "force"
    BRAINSTORE_URL                                    = var.brainstore_hostname != null ? "http://${var.brainstore_hostname}:${var.brainstore_port}" : ""
