...
#
#   # Optional, but recommended. Use a specific AWS credential profile for
#   # creating the Braintrust resources. This helps prevent accidental changes
...
#
#   # Optionally, you can add default tags to all resources created by this
#   # module.
#   default_tags {
#     tags = {
